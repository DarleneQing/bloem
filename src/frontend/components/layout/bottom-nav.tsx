        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-col items-center justify-center gap-1 rounded-xl px-3 py-2 text-xs font-medium transition-all duration-200 min-w-[60px] min-h-touch",
                isActive
                  ? "text-primary bg-secondary/10"
                  : "text-muted-foreground hover:text-primary hover:bg-secondary/5 active:scale-95"
              )}
            >
